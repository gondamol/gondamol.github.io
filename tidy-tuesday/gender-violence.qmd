---
title: "TidyTuesday: Gender-Based Violence Statistics"
...
Analysis of gender-based violence statistics data from TidyTuesday 2024 - Week of 2024-11-05
:::

## Overview

This project explores the **Gender-Based Violence Statistics** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-11-05/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-11-05"), by = "day", length.out = 100)
)
...
p1 <- ggplot(df_clean, aes(x = date, y = value, color = category)) +
  ...
  labs(
    title = "Gender-Based Violence Statistics",
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-11-05)
