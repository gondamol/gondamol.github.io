---
title: "TidyTuesday: Urban Population Growth"
subtitle: "SDG 11: Sustainable Cities and Communities"
...
Analysis of urban population growth data from TidyTuesday 2024 - Week of 2024-10-15
:::

## Overview

This project explores the **Urban Population Growth** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2024-10-15')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-10-15/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-10-15"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-10-15)
