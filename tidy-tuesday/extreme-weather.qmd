---
title: "TidyTuesday: Extreme Weather Events"
...
Analysis of extreme weather events data from TidyTuesday 2023 - Week of 2023-02-21
:::

## Overview

This project explores the **Extreme Weather Events** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2023-02-21')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2023/2023-02-21/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2023-02-21"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2023/2023-02-21)
