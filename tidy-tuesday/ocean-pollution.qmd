---
title: "TidyTuesday: Ocean Pollution Metrics"
...
::: {.hero-banner}
# **Ocean Pollution Metrics**

Analysis of ocean pollution metrics data from TidyTuesday 2024 - Week of 2024-04-16
:::

## Overview

This project explores the **Ocean Pollution Metrics** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2024-04-16')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-04-16/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-04-16"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-04-16)
