---
title: "TidyTuesday: Health Expenditure Analysis"
...
Analysis of health expenditure analysis data from TidyTuesday 2024 - Week of 2024-07-02
:::

## Overview

This project explores the **Health Expenditure Analysis** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2024-07-02')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-07-02/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-07-02"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-07-02)
