---
title: "TidyTuesday: Renewable Energy Adoption"
...
Analysis of renewable energy adoption data from TidyTuesday 2023 - Week of 2023-06-20
:::

## Overview

This project explores the **Renewable Energy Adoption** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2023/2023-06-20/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2023-06-20"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2023/2023-06-20)
