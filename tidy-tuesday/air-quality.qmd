---
title: "TidyTuesday: Urban Air Quality"
...
Analysis of urban air quality data from TidyTuesday 2024 - Week of 2024-11-12
:::

## Overview

This project explores the **Urban Air Quality** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-11-12/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-11-12"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-11-12)
