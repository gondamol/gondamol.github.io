---
title: "TidyTuesday: Water Access Indicators"
subtitle: "SDG 6: Clean Water and Sanitation"
...
Analysis of water access indicators data from TidyTuesday 2024 - Week of 2024-04-23
:::

## Overview

This project explores the **Water Access Indicators** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2024-04-23')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-04-23/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-04-23"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-04-23)
