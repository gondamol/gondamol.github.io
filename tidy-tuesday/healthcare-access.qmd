---
title: "TidyTuesday: Healthcare Access Indicators"
...
Analysis of healthcare access indicators data from TidyTuesday 2023 - Week of 2023-09-12
:::

## Overview

This project explores the **Healthcare Access Indicators** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2023/2023-09-12/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2023-09-12"), by = "day", length.out = 100)
)
...
p1 <- ggplot(df_clean, aes(x = date, y = value, color = category)) +
  ...
  labs(
    title = "Healthcare Access Indicators",
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2023/2023-09-12)
