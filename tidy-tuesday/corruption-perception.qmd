---
title: "TidyTuesday: Corruption Perception"
...
Analysis of corruption perception data from TidyTuesday 2023 - Week of 2023-09-19
:::

## Overview

This project explores the **Corruption Perception** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2023-09-19')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2023/2023-09-19/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2023-09-19"), by = "day", length.out = 100)
)
