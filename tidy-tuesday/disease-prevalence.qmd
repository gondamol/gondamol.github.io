---
title: "TidyTuesday: Disease Prevalence by Region"
...
Analysis of disease prevalence by region data from TidyTuesday 2023 - Week of 2023-07-11
:::

## Overview

This project explores the **Disease Prevalence by Region** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2023/2023-07-11/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2023-07-11"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2023/2023-07-11)
