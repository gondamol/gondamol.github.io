---
title: "TidyTuesday: Protected Areas Coverage"
...
Analysis of protected areas coverage data from TidyTuesday 2024 - Week of 2024-07-23
:::

## Overview

This project explores the **Protected Areas Coverage** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2024-07-23')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-07-23/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-07-23"), by = "day", length.out = 100)
)
...
p1 <- ggplot(df_clean, aes(x = date, y = value, color = category)) +
  ...
  labs(
    title = "Protected Areas Coverage",
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-07-23)
