---
title: "TidyTuesday: Energy Access Indicators"
...
Analysis of energy access indicators data from TidyTuesday 2024 - Week of 2024-01-30
:::

## Overview

This project explores the **Energy Access Indicators** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-01-30/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-01-30"), by = "day", length.out = 100)
)
...
p1 <- ggplot(df_clean, aes(x = date, y = value, color = category)) +
  ...
  labs(
    title = "Energy Access Indicators",
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-01-30)
