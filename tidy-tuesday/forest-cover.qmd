---
title: "TidyTuesday: Forest Cover Trends"
...
Analysis of forest cover trends data from TidyTuesday 2024 - Week of 2024-06-11
:::

## Overview

This project explores the **Forest Cover Trends** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2024-06-11')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-06-11/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-06-11"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-06-11)
