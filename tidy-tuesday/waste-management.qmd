---
title: "TidyTuesday: Waste Management Statistics"
...
Analysis of waste management statistics data from TidyTuesday 2024 - Week of 2024-01-09
:::

## Overview

This project explores the **Waste Management Statistics** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-01-09/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-01-09"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-01-09)
