---
title: "TidyTuesday: Gender Wage Gap Analysis"
...
Analysis of gender wage gap analysis data from TidyTuesday 2024 - Week of 2024-03-19
:::

## Overview

This project explores the **Gender Wage Gap Analysis** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2024-03-19')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-03-19/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-03-19"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-03-19)
