---
title: "TidyTuesday: Climate Finance"
...
Analysis of climate finance data from TidyTuesday 2024 - Week of 2024-02-06
:::

## Overview

This project explores the **Climate Finance** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-02-06/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-02-06"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-02-06)
