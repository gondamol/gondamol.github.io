---
title: "TidyTuesday: Rural Livelihoods Analysis"
...
Analysis of rural livelihoods analysis data from TidyTuesday 2023 - Week of 2023-10-10
:::

## Overview

This project explores the **Rural Livelihoods Analysis** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2023-10-10')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2023/2023-10-10/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2023-10-10"), by = "day", length.out = 100)
)
...
p1 <- ggplot(df_clean, aes(x = date, y = value, color = category)) +
  ...
  labs(
    title = "Rural Livelihoods Analysis",
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2023/2023-10-10)
