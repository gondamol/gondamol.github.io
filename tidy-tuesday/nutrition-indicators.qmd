---
title: "TidyTuesday: Nutrition Indicators"
...
Analysis of nutrition indicators data from TidyTuesday 2023 - Week of 2023-05-16
:::

## Overview

This project explores the **Nutrition Indicators** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2023-05-16')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2023/2023-05-16/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2023-05-16"), by = "day", length.out = 100)
)
