---
title: "TidyTuesday: Global Food Price Trends"
...
Analysis of global food price trends data from TidyTuesday 2024 - Week of 2024-04-09
:::

## Overview

This project explores the **Global Food Price Trends** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2024-04-09')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-04-09/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2024-04-09"), by = "day", length.out = 100)
)
...
p1 <- ggplot(df_clean, aes(x = date, y = value, color = category)) +
  ...
  labs(
    title = "Global Food Price Trends",
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2024/2024-04-09)
