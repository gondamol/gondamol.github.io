---
title: "TidyTuesday: Child Malnutrition Rates"
...
Analysis of child malnutrition rates data from TidyTuesday 2023 - Week of 2023-06-13
:::

## Overview

This project explores the **Child Malnutrition Rates** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2023-06-13')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2023/2023-06-13/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2023-06-13"), by = "day", length.out = 100)
)
...
p1 <- ggplot(df_clean, aes(x = date, y = value, color = category)) +
  ...
  labs(
    title = "Child Malnutrition Rates",
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2023/2023-06-13)
