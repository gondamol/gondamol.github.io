---
title: "TidyTuesday: Social Protection Programs"
...
Analysis of social protection programs data from TidyTuesday 2022 - Week of 2022-11-15
:::

## Overview

This project explores the **Social Protection Programs** dataset from TidyTuesday, focusing on data visualization and analysis techniques.
...
# tuesdata <- tt_load('2022-11-15')
# df <- tuesdata$data_name

# Alternative: Direct CSV download
# df <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2022/2022-11-15/data.csv')
...
df <- data.frame(
  ...
  date = seq.Date(from = as.Date("2022-11-15"), by = "day", length.out = 100)
)
...
- [Data Source](https://github.com/rfordatascience/tidytuesday/tree/master/data/2022/2022-11-15)
