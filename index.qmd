...
### Senior M&E Specialist | Research Data Manager | Research Data Analyst | 6+ Years Leading Global Health Projects
...
I am a **Senior M&E Specialist, Research Data Manager, and Research Data Analyst** with **6+ years of progressive experience** driving evidence-based decision-making for multi-million dollar international projects in **global health, food security, and economic development**. 
...
::: {.stat-card}
**6+**{.stat-number}
Years M&E Experience{.stat-label}
:::

::: {.stat-card}
**500+**{.stat-number}
Researchers Trained{.stat-label}
:::

::: {.stat-card}
**50+**{.stat-number}
Field Teams Led{.stat-label}
:::
...
::: {.stat-card}
**3**{.stat-number}
Published Papers{.stat-label}
:::

::: {.stat-card}
**1,535+**{.stat-number}
Multi-Country Sites{.stat-label}
:::

::: {.stat-card}
**8**{.stat-number}
M&E Frameworks Built{.stat-label}
:::
