...
<section class="hero reveal-on-scroll">
  <div class="hero-text">
    <p class="eyebrow">Research Data Manager · AI Systems · ML Infrastructure</p>
    <h1 class="hero-name">Nichodemus<br><em>Amollo</em></h1>
    <p class="hero-kicker">Statistical rigor for messy, real-world systems.</p>
    <p class="hero-bio">
      I work at the intersection of field research, data engineering, and AI systems.
      Designing surveys in communities with no internet, building the ETL pipelines
      that clean and model what comes back, and architecting ML systems that work in the real world.
      Eight years, four countries, one through-line: data that actually reaches the people 
      it was collected from—and systems that learn from it responsibly.
    </p>
    <div class="hero-proof-grid" aria-label="Selected proof points">
      <article class="hero-proof">
        <span class="hero-proof-label">Architecture</span>
        <strong class="hero-proof-value">1,000+ households</strong>
        <p class="hero-proof-text">ETL, quality monitoring, and dashboard workflows for health financial diaries.</p>
      </article>
      <article class="hero-proof">
        <span class="hero-proof-label">Operations</span>
        <strong class="hero-proof-value">50+ field staff</strong>
        <p class="hero-proof-text">Enumerator training, HFC systems, and delivery across multi-country studies.</p>
      </article>
      <article class="hero-proof">
        <span class="hero-proof-label">Direction</span>
        <strong class="hero-proof-value">AI-ready systems</strong>
        <p class="hero-proof-text">Repositioning toward reproducible ML, monitoring, and decision-grade analytics.</p>
      </article>
    </div>
  ...
  <div class="hero-visual">
    ...
    <div class="hero-focus-card">
      <p class="hero-focus-label">Current direction</p>
      <h2 class="hero-focus-title">Bridging research data management with AI-ready systems.</h2>
      <ul class="hero-focus-list">
        <li><span>01</span> Designing ETL, quality control, and Shiny workflows for health systems research.</li>
        <li><span>02</span> Building portfolio work around predictive analytics, reproducible ML, and analytics engineering.</li>
        <li><span>03</span> Open to roles where field reality, statistics, and systems design meet.</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="band-dark section-divider reveal-on-scroll">
  <div class="band-inner expertise-shell">
    <div class="expertise-intro">
      <p class="section-eyebrow light">Expertise</p>
      <h2 class="section-h light">Data and AI, owned end to end.</h2>
      <p class="section-sub light">The strongest work happens when study design, data operations, analytics, and model thinking reinforce each other instead of living in separate silos. That is the layer I like to operate in.</p>
      <div class="expertise-note">
        <span class="expertise-note-label">Positioning</span>
        <p>I am leaning harder into AI and ML systems, but the foundation stays the same: field reality, strong data quality discipline, and statistical thinking that keeps models honest.</p>
      </div>
    </div>
    ...
    <div class="expertise-grid">
      ...
      <article class="exp-card" tabindex="0">
        <div class="exp-card-head">
          ...
          <div class="exp-pill">Design &amp; delivery</div>
        </div>
        ...
        <h3 class="exp-title">Research &amp; M&amp;E Systems</h3>
        <p class="exp-body">Designing studies, digital instruments, and monitoring systems that hold up in low-connectivity, high-accountability environments.</p>
        <ul class="exp-points">
          <li>RCTs, quasi-experimental designs, and donor-ready reporting</li>
          <li>Enumerator training, HFC workflows, and cross-country field coordination</li>
        </ul>
        <div class="exp-chips">
          <span>ODK</span><span>KoboToolbox</span><span>REDCap</span><span>Stata</span>
        </div>
      ...
      <article class="exp-card" tabindex="0">
        <div class="exp-card-head">
          ...
          <div class="exp-pill">Analysis &amp; reporting</div>
        </div>
        <div class="exp-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7">
            <path d="M4 19h16"/>
        ...
        <h3 class="exp-title">Analytics &amp; Decision Support</h3>
        <p class="exp-body">Turning messy operational data into dashboards, briefs, and analyses that leaders can actually use to make decisions.</p>
        <ul class="exp-points">
          <li>SQL, R, and Python workflows for public health, agriculture, finance, and operations</li>
          <li>Power BI, Quarto, and Shiny outputs for funders, ministries, and delivery teams</li>
        </ul>
        <div class="exp-chips">
      ...
      <article class="exp-card" tabindex="0">
        <div class="exp-card-head">
          ...
          <div class="exp-pill">Infrastructure</div>
        </div>
        <div class="exp-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7">
        ...
        <h3 class="exp-title">Data Architecture &amp; Quality Ops</h3>
        <p class="exp-body">Owning the middle of the stack: ETL, validation rules, warehousing, and reproducible delivery across the full data lifecycle.</p>
        <ul class="exp-points">
          <li>PostgreSQL schemas, QA checks, and clean handoffs from collection to reporting</li>
          <li>Version-controlled workflows teams can rerun, audit, and improve without guesswork</li>
        </ul>
        <div class="exp-chips">
          <span>PostgreSQL</span><span>ETL</span><span>Git</span><span>DHIS2</span><span>Data QA</span>
        </div>
        <div class="exp-card-arrow">→</div>
      </article>

      <article class="exp-card exp-card--accent" tabindex="0">
        <div class="exp-card-head">
          <div class="exp-num">04</div>
          <div class="exp-pill">AI direction</div>
        </div>
        <div class="exp-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7">
            ...
            <path d="M10.2 10.7 6.2 8.1"/>
            <path d="m13.8 10.7 4-2.6"/>
            <path d="m10.7 13.6-2.5 3"/>
            <path d="m13.3 13.6 2.5 3"/>
          </svg>
        </div>
        <h3 class="exp-title">AI &amp; ML Systems</h3>
        <p class="exp-body">Applying statistical thinking to predictive systems, from feature design and causal framing to monitoring, drift checks, and responsible deployment.</p>
        <ul class="exp-points">
          <li>Building portfolio-grade ML use cases tied to real public-interest and operations problems</li>
          <li>Keeping interpretability, fairness, and reproducibility in the design loop from the start</li>
        </ul>
        <div class="exp-chips">
          <span>XGBoost</span><span>Causal Inference</span><span>R</span><span>Python</span><span>Model Monitoring</span>
        </div>
        <div class="exp-card-arrow">→</div>
      </article>
...
<section class="band-warm section-divider reveal-on-scroll">
  <div class="band-inner">
    ...
    <p class="section-sub">From the first community conversation to the final policy brief, through model deployment and monitoring. Every step, every time.</p>
    <div class="lifecycle-cards">
      ...
      <div class="lc-card" tabindex="0">
        ...
        <div class="lc-card-hover-text">Descriptive stats to advanced econometrics and ML. Difference-in-differences, survival analysis, causal inference, and predictive models with statistical rigor.</div>
      </div>
      ...
      <div class="lc-card" tabindex="0">
        ...
        <div class="lc-card-hover-text">Interactive dashboards, automated reports, and publication-ready charts that update with new data. Shiny apps with real-time predictions.</div>
      </div>
      ...
      <div class="lc-card" tabindex="0">
        <div class="lc-card-icon">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/><path d="M12 19V5"/><path d="M12 12l-6.93 4"/><path d="M12 12l6.93 4"/></svg>
        </div>
        <span class="lc-card-num">08</span>
        <h4 class="lc-card-name">Model Monitoring</h4>
        <p class="lc-card-tools">Data Quality · Drift Detection</p>
        <div class="lc-card-hover-text">Continuous monitoring of model performance and data quality. Automated alerts for drift, retraining triggers, and statistical guardrails.</div>
      </div>
...
<section class="section-pad section-divider reveal-on-scroll">
  <div class="section-inner">
    ...
    <p class="section-sub">Real work across public health, agriculture, finance, and development — from field surveys to ML systems and analytics pipelines.</p>
...
<section class="section-pad section-divider reveal-on-scroll">
  <div class="section-inner">
    ...
    <p class="section-sub">End-to-end support, from study design to decision-ready reporting and ML systems. Professional, reproducible, and built for real-world operations.</p>
    ...
    <div class="services-grid services-grid-home">
      ...
      <div class="svc-card">
        ...
        <p class="svc-body">Reproducible ETL pipelines, high-frequency checks, and database workflows in R, SQL, and Python.</p>
      ...
      <div class="svc-card">
        ...
        <p class="svc-body">Interactive dashboards with predictive components and concise reporting for funders, ministries, and executive teams.</p>
      ...
      <div class="svc-card">
        ...
        <p class="svc-body">Building production-ready models grounded in statistical rigor. Model deployment, monitoring, and reproducible infrastructure.</p>
        <div class="svc-tags"><span>Causal Inference</span><span>Model Ops</span><span>R/Python</span></div>
      </div>
    </div>
      ...
      <div class="cv-col">
        ...
        <div class="cv-item">
          ...
          <div class="cert-list">
            ...
            <span class="cert-badge">M&amp;E in Global Health</span>
            <span class="cert-badge">Economic Evaluation</span>
            <span class="cert-badge">Biomedical Research Ethics</span>
...
<section class="section-pad section-divider reveal-on-scroll" id="contact">
  <div class="section-inner contact-grid">
    <div class="contact-left">
      ...
      <p class="contact-intro">Whether you need a research partner, an analyst to embed in your team, or someone to build your data and AI systems from scratch, I would like to hear from you.</p>
