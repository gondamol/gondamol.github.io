  ...
  <div class="section-inner">
    ...
    <div class="project-grid" id="projectGrid">
      ...
      <a href="research/thesis.html" class="proj-card proj-featured" data-category="health">
        ...
        <div class="proj-body">
          <p class="proj-domain" style="color:#7fbf7f;">Public Health · Accepted manuscript · Kisumu County</p>
          <h3 class="proj-title">Financing Chronic Care in Rural Kenya</h3>
          <p class="proj-desc">Seven-facility mixed-methods study in Seme Sub-County showing how narrow funding streams, county approval delays, and missing NCD budget lines disrupt hypertension and diabetes care. Accepted in BMC Public Health.</p>
