...
```{webr-r}
programme <- data.frame(
  county = c("Kisumu", "Kisumu", "Homa Bay", "Siaya", "Siaya"),
  month = c("Jan", "Feb", "Jan", "Jan", "Feb"),
  visits = c(128, 141, 96, 87, 111)
)

aggregate(visits ~ county, data = programme, FUN = sum)
```
