...
<div class="section-inner">
  ...
  <div class="project-grid allProjects" style="margin-bottom:5rem;">
    ...
    <div class="proj-card proj-half" data-category="finance">
      ...
      <div class="proj-body">
        <p class="proj-domain" style="color:#6fa8dc;">Urban economics · Nairobi</p>
        <h3 class="proj-title">Nairobi Real Estate Dashboard</h3>
        <p class="proj-desc">Developed exploratory real estate analytics with neighborhood segmentation, trend decomposition, and valuation support indicators for investor and planning teams.</p>
        <div class="proj-footer">
          <span class="proj-tags"><span>Spatial analysis</span><span>Power BI</span><span>Valuation</span></span>
          <span class="proj-arrow">Case brief</span>
        </div>
      </div>
    </div>
  ...
  <div class="project-grid allProjects" style="margin-bottom:2rem;">
    ...
    <div class="proj-card proj-half" data-category="analytics">
      ...
      <div class="proj-body">
        <p class="proj-domain" style="color:#8cb5d9;">Operations intelligence · Tatu City</p>
        <h3 class="proj-title">Supply Chain Intelligence for Tatu City Operations</h3>
        <p class="proj-desc">Defined data model requirements for shipment visibility, stock accuracy, and service level tracking across procurement and delivery stages.</p>
        <div class="proj-footer">
          <span class="proj-tags"><span>SQL</span><span>Dashboards</span><span>Operations</span></span>
          <span class="proj-arrow">Case brief</span>
        </div>
      </div>
    </div>
