...
Showcasing 7+ years of impactful work in health data analytics, data management, and digital health solutions — with a special focus on health financial diaries, health economics, and rigorous impact evaluation.
:::
...
::: {.skill-category}
### [🚀 Real-Time Analytics Engineering](analytics-engineering/) **NEW!**
End-to-end automation projects solving real-world problems:
- Job Market Intelligence (web scraping + NLP)
- E-commerce Price Tracker (Jumia, Kilimall, Amazon)
- Social Media Analytics (sentiment analysis)
- Supply Chain Intelligence (logistics tracking)
- Healthcare Readmission Risk (ML prediction)

**Impact:** Live data pipelines, real users, automation at scale
:::
