...
::: {.hero-banner}
# 🌍 Food Security Early Warning (Kenya demo)
...
- Produces **map, alert table, and trend chart** — all reproducible from the repo with no internet

## 📦 Data included (repo)

- `data/food-security/market_prices.csv` — 10 days of maize/beans prices for Nairobi, Kisumu, Eldoret with lat/long
- `data/food-security/rainfall.csv` — matching daily rainfall for the same locations
...
knitr::kable(top_alerts, caption = paste0("Top Markets by Risk — ", latest_date))
...
- Nairobi shows a short-term maize spike with simultaneous low rainfall → higher composite risk.
...
[← Back to Agriculture](index.qmd) | [← All Projects](../index.qmd)
