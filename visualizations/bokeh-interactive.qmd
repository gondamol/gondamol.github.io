...
subtitle: "Advanced visualization techniques using bokeh, pandas, numpy"
format:
  html:
    toc: true
    code-fold: show
...
This project demonstrates advanced visualization techniques using **bokeh, pandas, numpy**.
:::
