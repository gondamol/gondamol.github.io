...
**Status:** Preprint available (not peer reviewed) | **DOI:** [10.21203/rs.3.rs-8079392/v1](https://doi.org/10.21203/rs.3.rs-8079392/v1) | **License:** CC BY 4.0 | **Expected Journal Submission:** 2025
:::
...
[View Survey Tools Documentation →](#survey-tools)
:::
:::
...
✅ **Open Data** - Anonymized data will be shared in public repositories  
✅ **Open Code** - All analysis scripts available on GitHub  
✅ **Open Methods** - Detailed methodology documentation  
✅ **Transparent Reporting** - Adherence to STROBE guidelines  
✅ **Version Control** - All changes tracked with Git  

[View GitHub Repository →](https://github.com/gondamol/thesis-ncd-financing)
...
💼 [LinkedIn: Nichodemus Amollo](https://linkedin.com/in/amollow)  
🐙 [GitHub: gondamol](https://github.com/gondamol)
...
[← Back to Research](publications.qmd) | [View All Projects →](../projects/index.qmd)
