...
listing:
  contents:
    - "../posts/47-facility-decision-space-chronic-care/index.qmd"
    - "../posts/kisumu-cancer-dashboard/index.qmd"
    - "../posts/30-health-financial-diaries-explainer/index.qmd"
    - "../posts/48-from-field-to-model/index.qmd"
    - "../posts/49-reproducible-ml-research-data-manager/index.qmd"
    - "../posts/50-ai-low-resource-settings/index.qmd"
    - "../posts/51-statistical-thinking-ai-engineering/index.qmd"
    - "../posts/52-dashboards-to-decisions/index.qmd"
    - "../posts/24-mobile-data-collection/index.qmd"
    - "../posts/22-reproducible-research-public-health/index.qmd"
    - "../posts/39-survey-design-mistakes/index.qmd"
    - "../posts/38-statistical-power-for-evaluators/index.qmd"
  sort: "date desc"
  type: grid
  grid-columns: 3
  categories: true
...
<section class="bx-hero reveal-on-scroll">
  <div class="bx-hero-inner">
    <div class="bx-hero-copy">
      ...
      <p class="bx-overline">Research translation · Field systems · Methods</p>
      <h1 class="bx-hero-heading">Essays &amp; Field Notes</h1>
      <p class="bx-hero-lead">A short public set of writing grounded in health systems research and programme data work. Clarity over volume. No career listicles.</p>
    ...
    <div class="bx-hero-aside">
      ...
      <div class="bx-metric-card">
        <span class="bx-metric-num">12</span>
        <span class="bx-metric-label">Curated public notes — research, field systems, and methods</span>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="bx-section-inner">
    ...
    <div class="bx-picks-grid">
      ...
      <a class="bx-pick-card bx-pick--secondary" href="../posts/30-health-financial-diaries-explainer/index.html">
        <span class="bx-tag bx-tag--health">Field systems</span>
        <h4>Health financial diaries</h4>
        <p>High-frequency household finance data — context for the systems case study.</p>
      </a>

      <a class="bx-pick-card bx-pick--secondary" href="../posts/48-from-field-to-model/index.html">
        <span class="bx-tag bx-tag--technical">Methods</span>
        <h4>From field to model</h4>
        <p>Why domain knowledge still shapes useful targeting and ML systems.</p>
      </a>

      <a class="bx-pick-card bx-pick--secondary" href="../posts/kisumu-cancer-dashboard/index.html">
        <span class="bx-tag bx-tag--research">Delivery</span>
        <h4>Kisumu cancer dashboard</h4>
        <p>Research data management through to a county-facing surveillance product.</p>
      </a>
    </div>
  </div>
</section>
